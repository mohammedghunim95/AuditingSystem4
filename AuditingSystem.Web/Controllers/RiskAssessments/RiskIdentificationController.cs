...
namespace AuditingSystem.Web.Controllers.RiskAssessments
{
    public class RiskIdentificationController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            ViewBag.RiskImpactId = new SelectList(riskImpact.Select(r => new { Id = r.Id, Name = $"{r.Name} - {r.Rate}" }), "Id", "Name", riskIdentification.RiskImpactId);
            ViewBag.RiskLikelihoodId = new SelectList(likelihood.Select(l => new { Id = l.Id, Name = $"{l.Name} - {l.Rate}" }), "Id", "Name", riskIdentification.RiskLikelihoodId);
